...
public class MainActivityNotes extends ActionBarActivity implements AdapterView.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityNotes.this, EditActivity.class);
